...
def main():
    ...
    palm_model = cv.dnn.readNet('./models/palm_detection_mediapipe_2023feb.onnx')
    ...
    hand_model = cv.dnn.readNet('./models/handpose_estimation_mediapipe_2022may.onnx')
...
def recognizeHandPose(bending1, bending2, bending3, bending4, bending5):
    ...
    rps = 'None'
    if (bending1 > 0.8 and bending2 > 0.8 and bending3 > 0.8 and bending4 > 0.8 and bending5 > 0.8):
        rps = '5'
    elif (bending1 < 0.5 and bending2 > 0.8 and bending3 > 0.8 and bending4 > 0.8 and bending5 > 0.8):
        rps = '4'
    elif (bending1 <0.5 and bending2 < 0.5 and bending3 > 0.8 and bending4 > 0.8 and bending5 > 0.8):
        rps = '3'
    elif (bending1 < 0.5 and bending2 > 0.8 and bending3 > 0.8 and bending4 < 0.5 and bending5 < 0.5):
        rps = '2'
    elif (bending1 < 0.6 and bending2 > 0.8 and bending3 < 0.6 and bending4 < 0.6 and bending5 < 0.6):
        rps = '1'
    else:
        rps = 'None'
